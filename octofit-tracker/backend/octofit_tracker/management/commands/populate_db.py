...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        team2.members.set(users[3:])  # Add last two users to Gold Team

        # Create activities
        activities = [
            Activity(user=users[0], activity_type='Cycling', duration=60, date=date(2025, 5, 30)),
            Activity(user=users[1], activity_type='Crossfit', duration=120, date=date(2025, 5, 30)),
            Activity(user=users[2], activity_type='Running', duration=90, date=date(2025, 5, 30)),
            Activity(user=users[3], activity_type='Strength', duration=30, date=date(2025, 5, 30)),
            Activity(user=users[4], activity_type='Swimming', duration=75, date=date(2025, 5, 30)),
        ]
